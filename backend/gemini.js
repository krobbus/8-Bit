...
app.post("/api/generate-quiz", async (req, res) => {
  ...
  ${userAnswer ? `User Answered: "${userAnswer}"` : ""}"
  ...
  === RULES PER QUIZ TYPE ===
    ...
    - Questions should be clear and assess foundational knowledge, mixed of easy and medium difficulty.
  ...
  === COMPONENT RULES ===
  STRICT RULES FOR EXPLANATION (REQUIRED FOR ALL):
